<?php
    ...
    $accion_crear_vista = "E";
$sql_create_view = "CALL SP_Master(?, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)";
$stmt_create_view = $conn->prepare($sql_create_view);
$stmt_create_view->bind_param("s", $accion_crear_vista);
$stmt_create_view->execute();
$stmt_create_view->close();

// Luego consultar la vista directamente
$sql = "SELECT * FROM vista_solicitudes_pendientes WHERE amigo_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $p_usuarios_id);
...
$stmt->close();
    ...
    $sql = "SELECT * FROM vista_amigos_aceptados WHERE usuario_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $p_usuarios_id);
